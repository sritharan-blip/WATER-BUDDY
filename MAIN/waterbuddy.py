...
def _register_case_compatible_packages() -> None:
    """Allow imports to work when the repo folder names use different casing on Linux hosts."""
    package_aliases = {
        "core": ("core", "CORE"),
        "services": ("services", "SERVICES"),
    }
    for package_name, candidates in package_aliases.items():
        if package_name in sys.modules:
            continue
        for candidate in candidates:
            package_dir = ROOT_DIR / candidate
...
_register_case_compatible_packages()
